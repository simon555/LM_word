...
class LstmLm(nn.Module):
    ...
    def train_epoch(self, iter, loss, optimizer, viz, win, TEXT, args, infoToPlot=None):
        ...
        for batch in iterable:
            ...
            if batch_id % self.args.Nplot == 0:
                ...
                sampled_sentences=self.generate_predictions(TEXT, iter)
    ...
    def generate_predictions(self, TEXT, iterator, outputDirectory=None, epoch=None, saveOutputs=False):
...
#            self.generationIteratorBuilt=True
        ...
        local_iterator=iter(iterator)
        sample=next(local_iterator)
    ...
    def save_model(self, args):
        torch.save(self.cpu().state_dict(), os.path.join(args.directoryCkpt,self.__class__.__name__ + ".pth"))
