...
def cleanData(fileText):
    ...
    with open(fileText) as tsvfile:
        ...
        for row in reader:
            ...
            with open('./data/clean/clean.txt', 'a') as outstream:
...
def splitData():
    ...
    '''
    with open('./data/clean/clean.txt') as file:
        i=0
        for line in file.readlines():
            print(line)
            if i<12000:
                with open('./data/train/train.txt', 'a') as outstream:
                    outstream.write(line) 
            elif 12000<i and i < 15000 :
                with open('./data/valid/valid.txt', 'a') as outstream:
                    outstream.write(line) 
            elif 15000<i :
                with open('./data/test/test.txt', 'a') as outstream:
                    outstream.write(line) 
            i+=1
